...
import 'package:mymovieapp/models/cast_crew.dart';
import 'dart:convert';
...
class _MovieDetails extends State<MovieDetail> {
  String movieDetailUrl, movieCreditsUrl;
  ...
  void initState() {
    super.initState();
    movieDetailUrl = "$baseUrl${widget.movie.id}?api_key=$apiKey&language=es";
    movieCreditsUrl =
        "$baseUrl${widget.movie.id}/credits?api_key=$apiKey&language=es";
    _fetchMovieDetails();
    _fetchMovieCredits();
  }
